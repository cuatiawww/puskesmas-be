...
<div class="card">
    <div class="card-header">
        ...
        <p class="mb-0 text-muted">Tentukan kabupaten/kota induk untuk kecamatan ini.</p>
    </div>
    <div class="card-body">
        <div class="row g-3">
            <div class="col-md-4">
            ...
            <div class="col-md-6">
                <?= $form->field($model, 'parent_master_wilayah_id')->dropDownList($parentOptions, ['prompt' => 'Pilih Kabupaten/Kota']) ?>
            </div>
            <div class="col-md-6">
