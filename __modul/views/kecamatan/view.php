...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <div>
            <h5 class="mb-1">DETAIL KECAMATAN</h5>
            <p class="mb-0 text-muted">Informasi lengkap data kecamatan.</p>
        </div>
    ...
    <div class="card-body">
        <table class="table table-bordered">
            ...
            <tr><th>Nama Kecamatan</th><td><?= Html::encode((string) $model->nama_wilayah) ?></td></tr>
            <tr><th>Kabupaten/Kota</th><td><?= Html::encode((string) ($model->parent->nama_wilayah ?? '-')) ?></td></tr>
