...
$this->title = 'Manajemen Sub-Modul';
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        <div>
          <h5>DAFTAR SUB-MODUL</h5>
          <p>Daftar sub-modul yang tersedia dalam sistem.</p>
        </div>
        <a href="<?= Url::to(['sub-modul/create']) ?>" class="btn btn-sm btn-primary">
          ...
          <?= GridView::widget([
            ...
            'columns' => [
              ...
              [
                ...
                'header' => 'Modul',
                'value' => function($model) {
                  return $model->parentSubModul ? $model->parentSubModul->label : '-';
                },
              ],
              [
                'attribute' => 'is_active',
