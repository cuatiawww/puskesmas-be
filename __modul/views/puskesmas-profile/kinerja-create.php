...
$this->title = 'Tambah Laporan Periodik';
    ...
    <div class="row align-items-center justify-content-between">
      <div class="col-sm-auto">
        <div class="page-header-title">
          <h5 class="mb-0 fw-bold">TAMBAH LAPORAN KINERJA PERIODIK</h5>
          <p>Input data kesiapan dan penilaian kinerja untuk Puskesmas <?= Html::encode($puskesmas->nama_puskesmas) ?>.</p>
        </div>
      </div>
      <div class="col-sm-auto">
        <ul class="breadcrumb">
