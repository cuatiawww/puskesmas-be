...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (elem) {
    if (sessionStorage.getItem("loaderShown") === "true") {
      // Pre-loader sudah ditampilkan sebelumnya, hapus langsung tanpa animasi
      elem.remove();
    } else {
      // Tampilkan pre-loader untuk pertama kali dalam sesi
      ...
      setTimeout(function () {
        elem.remove();
        // Tandai bahwa pre-loader sudah ditampilkan
...
function layout_change(layout) {
  ...
  if (layout == "dark") {
    ...
    if (document.querySelector(".auth-form .card-footer a img")) {
      document
        .querySelector(".auth-form .card-footer a img")
        .setAttribute("src", "../assets/images/logo-white-sm.svg");
    }
    ...
    if (document.querySelector(".auth-form .card-footer a img")) {
      document
        .querySelector(".auth-form .card-footer a img")
        .setAttribute("src", "../assets/images/logo-dark-sm.svg");
    }
    var control = document.querySelector(".theme-layout .btn.active");
    if (control) {
      document
