...
<meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="app_asset/icon/themify-icons/themify-icons.css">
    <!-- ico font -->
    <link rel="stylesheet" type="text/css" href="app_asset/icon/icofont/css/icofont.css">
    <!-- flag icon framework css -->
    <link rel="stylesheet" type="text/css" href="app_asset/pages/flag-icon/flag-icon.min.css">
    <!-- Menu-Search css -->
    <link rel="stylesheet" type="text/css" href="app_asset/pages/menu-search/css/component.css">
    <!-- Data Table Css -->
    <link rel="stylesheet" type="text/css" href="bower_components/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="app_asset/pages/data-table/css/buttons.dataTables.min.css">
    <link rel="stylesheet" type="text/css" href="bower_components/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css">
    <!-- Style.css -->
    <link rel="stylesheet" type="text/css" href="app_asset/css/style.css">
    <!--color css-->
    <link rel="stylesheet" type="text/css" href="app_asset/css/color/color-1.css" id="color"/>
    <link rel="stylesheet" type="text/css" href="app_asset/css/linearicons.css" >
	<link rel="stylesheet" type="text/css" href="app_asset/css/simple-line-icons.css">
	<link rel="stylesheet" type="text/css" href="app_asset/css/ionicons.css">
	<link rel="stylesheet" type="text/css" href="app_asset/css/jquery.mCustomScrollbar.css">
	...
	<script type="text/javascript" src="app_asset/pages/dashboard/horizontal-timeline/js/main.js"></script>
	<!-- amchart js -->
	<script type="text/javascript" src="app_asset/pages/dashboard/amchart/js/amcharts.js"></script>
	<script type="text/javascript" src="app_asset/pages/dashboard/amchart/js/serial.js"></script>
	<script type="text/javascript" src="app_asset/pages/dashboard/amchart/js/light.js"></script>
	<script type="text/javascript" src="app_asset/pages/dashboard/amchart/js/custom-amchart.js"></script>
	<!-- i18next.min.js -->
	...
	<!-- Custom js -->	
	<script type="text/javascript" src="app_asset/js/script.js"></script>

	<!-- pcmenu js -->
	<script src="app_asset/js/pcoded.min.js"></script>
	<script src="app_asset/js/demo-12.js"></script>
	<script src="app_asset/js/jquery.mCustomScrollbar.concat.min.js"></script>
	<script src="app_asset/js/jquery.mousewheel.min.js"></script>
	
	<!-- data-table js -->
    <script src="bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
    <script src="bower_components/datatables.net-buttons/js/dataTables.buttons.min.js"></script>
    <script src="app_asset/pages/data-table/js/jszip.min.js"></script>
    <script src="app_asset/pages/data-table/js/pdfmake.min.js"></script>
    <script src="app_asset/pages/data-table/js/vfs_fonts.js"></script>
...
<body >
			...
			<div id="pcoded" class="pcoded">
				...
				<div class="pcoded-container navbar-wrapper">
					<?php //include '__si44/__template/header/header.php'; ?>
					 <div class="pcoded-main-container">
                		<div class="pcoded-wrapper">
							<?php //include '__si44/__template/body/left.php'; ?>
